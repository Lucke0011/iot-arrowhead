...
@Component
public class ThermostatApplicationInitListener extends ApplicationInitListener {
	...
	private final Logger logger = LogManager.getLogger(ThermostatApplicationInitListener.class);
